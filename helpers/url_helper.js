//REGISTER
export const POST_FAKE_REGISTER = "https://www.comfytrack.net/PHP/login/signup.php";

//LOGIN
export const POST_FAKE_LOGIN = "https://www.comfytrack.net/PHP/login/login.php";
export const POST_FAKE_JWT_LOGIN = "https://www.comfytrack.net/PHP/login/login.php";
export const POST_FAKE_PASSWORD_FORGET = "sil";
export const POST_FAKE_JWT_PASSWORD_FORGET = "https://www.comfytrack.net/PHP/login/send_password_link.php";
