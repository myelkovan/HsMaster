//REGISTER
export const POST_FAKE_REGISTER = "https://login.hsmaster.ai/PHP/login/signup.php";

//LOGIN
export const POST_FAKE_LOGIN = "https://login.hsmaster.ai/PHP/login/login.php";
export const POST_FAKE_JWT_LOGIN = "https://login.hsmaster.ai/PHP/login/login.php";
export const POST_FAKE_PASSWORD_FORGET = "sil";
export const POST_FAKE_JWT_PASSWORD_FORGET = "https://login.hsmaster.ai/PHP/login/send_password_link.php";
