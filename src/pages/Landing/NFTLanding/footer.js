                        ...
                        <Col lg={4} className="mt-4">
                            <div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <p>You can build any type of web application like eCommerce, CRM, CMS, Project management apps, Admin Panels, etc using ComfyTrack.</p>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col sm={6}>
                            ...
                            <div>
                                <p className="copy-rights mb-0">
                                    {new Date().getFullYear()} © ComfyTrack
                                </p>
                            </div>
                        </Col>
                        <Col sm={6}>
