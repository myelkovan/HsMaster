...
const SiteMap = () => {
    document.title="SiteMap " + process.env.REACT_APP_NAME;
    return (
        <div>
                                            ...
                                            <ul className="administration">
                                                <li>
                                                    <ul className="director">
                                                        <li>
                                                            <Link to="#"
                                                                className="fw-semibold"><span>{process.env.REACT_APP_NAME} Admin</span></Link>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0 list-unstyled">
                                                    <li className="p-0 parent-title"><Link to="#" className="fw-medium fs-14">{process.env.REACT_APP_NAME}</Link></li>
                                                    <li>
                                                        <div className="first-list">
                                                            <div className="list-wrap">
