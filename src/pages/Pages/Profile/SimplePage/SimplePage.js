                                ...
                                <div className="p-2">
                                    ...
                                    <div className="hstack text-white-50 gap-1">
                                        <div className="me-2"><i
                                            ...
                                            United States</div>
                                        <div><i
                                            className="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>Yelkovan
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                                ...
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 fs-15">
                                                            <Link to="#"
                                                                className="badge badge-soft-primary">Photoorders</Link>
                                                            <Link to="#"
                                                                                            ...
                                                                                            <div className="d-flex">
                                                                                                <div className="avatar-xs">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <i
                                                                                                            className="ri-ordersping-bag-line"></i>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    className="flex-grow-1 ms-3">
                                                        ...
                                                        <div className="flex-shrink-0">
                                                            <div className="avatar-xs acitivity-avatar">
                                                                <div
                                                                    ...
                                                                    <i className="ri-ordersping-bag-line"></i>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
