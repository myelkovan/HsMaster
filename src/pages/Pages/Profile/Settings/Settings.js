/*
Kullanicinin profilini gosterir. Sayfaya gonderirlen user_id degerine gore kullaniciyi gosterir
Kullanicinin yetkisine gore sayfanin altinda yetkilendirme ve performans degeri girme ekrani acilir

Yapilacaklar
Bir kullanicinin profiline bakarken menuden my profile secenegini secince sayfa tetiklenmiyor
*/
...
//import {Button, Dropdown, Container, Row, Col, Tab, Tabs} from 'react-bootstrap'
//import {Box,FormControl, FormGroup, FormControlLabel, useFormControl, TextField, Select, MenuItem, options, option, Autocomplete, Checkbox  } from '@mui/material';
...
//import {user_id, user_permission_level, user_token  } from "./app/UserSlice";
import {getCountry, getCity, getSector, getPosition} from '../../../../services/service_lookupTables';
import {getUser} from '../../../../services/service_user';
//ChartJS.register(RadialLinearScale, PointElement, LineElement, Filler, Tooltip, Legend);
//import {Typography,Slider, Input, Grid, styled}  from '@mui/material';
...
const Settings = (props) => {
    ...
    const [reliability_score, setScore1] = useState([]);
    const [responsibility_score, setScore2] = useState([]);
    const [teamwork_score, setScore3] = useState([]);
    const [response_time_score, setScore4] = useState([]);
    const [work_score, setScore5] = useState([]);
    const [userSector, setUserSector] = useState([]);
    const [picture_file, setPictureFile] = useState([]);
    const [picture, setPicture] = useState([]);
    //const stored_permission_level = useSelector(user_permission_level);
    //const stored_user_id = useSelector(user_id);
    //const stored_token = useSelector(user_token);
    const navigate = useNavigate();
    const location = useLocation();


    const { user } = useSelector(state => ({ user: state.Profile.user }));
                                ...
                                <div className="text-end p-3">
                                    <div className="p-0 ms-auto rounded-circle profile-photo-edit">
                                        ...
                                        <Label htmlFor="profile-foreground-img-file-input"
                                            ...
                                            <i className="ri-image-edit-line align-bottom me-1"></i> {props.t("Change Cover")}
                                        </Label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <CardBody>
                                    ...
                                    <div className="mb-3 d-flex">
                                        ...
                                        <Input type="text" className="form-control" id="websiteInput"
                                            placeholder="www.example.com" defaultValue="www.comfytrack.net" />
                                    </div>
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="firstnameInput"
                                                                placeholder="Enter your firstname" defaultValue="Murat" />
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                        <div className="mb-3">
