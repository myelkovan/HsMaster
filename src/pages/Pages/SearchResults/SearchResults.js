...
document.title="Search Results | " + process.env.REACT_APP_NAME;
                            ...
                            <Card>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                <h5 className="mb-1"><Link to="#">ComfyTrack - Responsive Bootstrap 5 Admin Dashboard</Link></h5>
                                                <p className="text-success mb-2">https://Yelkovan.com/velzon/index.html</p>
                                                <p className="text-muted mb-2">ComfyTrack admin is super flexible, powerful, clean, modern & responsive admin template based on <span className="fw-semibold">bootstrap 5</span> stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using Velzon it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.</p>
                                                    ...
                                                    <li className="list-inline-item">
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="flex-grow-1 fs-13 ms-1">
                                                                <span className="fw-medium">Yelkovan</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="py-3">
                                                <h5 className="mb-1"><Link to="#">Skote - Admin & Dashboard Template by Yelkovan</Link></h5>
                                                <p className="text-success mb-2">https://Yelkovan.com/skote/</p>
                                            ...
                                            <div className="py-3">
                                                ...
                                                <p className="text-success mb-2">https://Yelkovan.com/minia/react/</p>
                                            ...
                                            <div className="py-3">
                                                <h5 className="mb-1"><Link to="#">Doson - Angular Admin & Dashboard Template by Yelkovan</Link></h5>
                                                <p className="text-success mb-2">https://Yelkovan.com/dason/angular/</p>
