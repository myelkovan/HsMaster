...
document.title="Timeline " + process.env.REACT_APP_NAME;
                                ...
                                <div className="timeline">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a ComfyTrack. Use the velzon to share information with your team to understand and contribute to your project.</p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>ComfyTrack admin dashboard templates layout upload</h5>
                                    ...
                                    <div className="timeline-continue">
                                        ...
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        <h5>ComfyTrack - Project Discussion</h5>
