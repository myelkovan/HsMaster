...
$productDescriptions = [["1", "Baby doll"], ["2", "toilet paper"], ["3", "iphone 16 pro max"]];
...
if ($response === FALSE) {
    ...
    if (isset($result['error'])) {
        ...
        $karsiya_donecek_hata = "ErrorCode:" . $errorCode . ' errorMessage:An unexpected error occurred. Please try again later.';
