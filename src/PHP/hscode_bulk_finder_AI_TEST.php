...
$user_id = 7;   // test için şimdilik bu userı kullanıyoruz
...
// $apiKey = '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'; // ← Buraya kendi API anahtarını yaz

// $apiUrl = 'https://api.openai.com/v1/chat/completions';


// // Kullanıcı verisinden prompt oluştur
// $userPrompt = json_encode($productDescriptions);

// // Sistem mesajı: sadece düz 2D JSON dizisi istiyoruz
...
// Summary bilgilerini ekrana yazdır
...
//$tokenIncrement = (int) $summary['success'];
