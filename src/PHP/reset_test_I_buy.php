...
$sql ="INSERT INTO `u242434967_jetbasket1`.`orders`
    ...
    VALUES
    (109, 22, 1 , NOW(), NULL, 'A180', 'e-PAQ Select Direct Access Canada DDP', 11.78, 11.78, 5.00, 5.00, 0.00, 8.53, 8.53, 0.00, 16.78, 0.33, 5.00, 2.00, 2.00, 5.00, NULL,  NULL, NULL, NULL, 'prod_RbwqGxk1U7kbXQ', 
    NOW(), NULL, NULL, NULL, NULL,NULL, NULL, 'Ablam', 'Ozlem Ucar', '363 Rue Massé', 'Granby', 'QC', 'V7V 2P6', 'Canada', '18566569294', NULL,NULL)";
...
$sql ="INSERT INTO `u242434967_jetbasket1`.`deposit`
(`user_id`,`date`,`amount`,`description`,`orders_id`,`stripe_product_id`,`shipment_refund`)
SELECT 109, NOW(), -16.78, NULL, NULL, NULL, NULL";
echo f_update($sql, $conn, false);  
