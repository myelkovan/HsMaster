...
if ($metod === "getRates_FromByeLabel") {
    ...
    $to_zipcode = 'V6X 3S8';    $to_country_code = 'CA';
    $from_zipcode = '08110';    $from_country_code = 'US';
    $weight = "1";    $length = "1";
    $width = "1";    $height = "1";
    $from_state="";     $to_state="";    //  $from_state="CA"; $to_state="BC";
    $from_city = "";    $to_city = "";    //  $from_city="Vancouver"; $to_city="Vancouver";
    $from_street_1="";  $from_street_2="";    $from_street_3 = "";    //  $from_street_1="123"; $from_street_2="456"; $from_street_3="678";
    $to_street_1 = "";    $to_street_2 = "";    $to_street_3 = "";    //  $to_street_1="789"; $to_street_2="012"; $to_street_3="345";
    $carrier_code = null;
...
if ($metod === "trackShipment_FromByeLabel") {
    ...
    $tracking_number= 'AS002984275US';  //'F653322F880147569A6D'; // 8045211460104EB6BD24 '';    //'E30111776AC54FF88E0A';
