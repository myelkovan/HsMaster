...
// Ecommerce > ordersping Cart

const orderspingCart = [
  {
    id: 1,
    img: product8,
    name: "Sweatshirt for Men (Pink)",
...
export { productsData, productDetailsWidgets, reviews, orders, productDetails, customerList, orderspingCart, orderSummary, sellersList, revenueWidgets, productsReview };